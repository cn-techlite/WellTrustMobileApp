...
class AccomodationState {
  final List<AccomodationResponseModel> listAccomodation;
  final AccomodationResponseModel? singleData;
  final int page;
  final int pageSize;
  ...
  const AccomodationState({
    this.listAccomodation = const [],
    this.singleData,
    this.page = 1,
    this.pageSize = 20,
  ...
  AccomodationState copyWith({
    List<AccomodationResponseModel>? listAccomodation,
    AccomodationResponseModel? singleData,
    int? page,
    int? pageSize,
    ...
    return AccomodationState(
      listAccomodation: listAccomodation ?? this.listAccomodation,
