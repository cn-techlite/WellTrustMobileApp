...
PackageOrderPaginatedModel packageOrderPaginatedModelFromJson(String str) =>
    PackageOrderPaginatedModel.fromJson(json.decode(str));

String packageOrderPaginatedModelToJson(PackageOrderPaginatedModel data) =>
    json.encode(data.toJson());

class PackageOrderPaginatedModel {
  final List<PackageOrderResponseModel>? data;
  ...
  PackageOrderPaginatedModel copyWith({
