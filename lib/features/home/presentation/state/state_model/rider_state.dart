...
class RidersState {
  ...
  final RidersResponseModel? singleData;
  final int page;
  final int pageSize;
  ...
  RidersState copyWith({
    List<RidersResponseModel>? listRiders,
    RidersResponseModel? singleData,
    int? page,
    int? pageSize,
    ...
    return RidersState(
      listRiders: listRiders ?? this.listRiders,
