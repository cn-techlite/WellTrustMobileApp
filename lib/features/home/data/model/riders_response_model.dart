...
RidersPaginatedModel ridersPaginatedModelFromJson(String str) =>
    RidersPaginatedModel.fromJson(json.decode(str));

String ridersPaginatedModelToJson(RidersPaginatedModel data) =>
    json.encode(data.toJson());

class RidersPaginatedModel {
  final List<RidersResponseModel>? data;
...
class DeviceTokenModel {
  ...
  DeviceTokenModel({this.id, this.deviceTokenId, this.userId, this.userType});
