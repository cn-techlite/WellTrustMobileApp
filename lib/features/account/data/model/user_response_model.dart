...
class RegisterResponseModel {
  ...
  RegisterResponseModel copyWith({
    ...
    List<DeviceTokenModel>? deviceTokenModels,
    DateTime? createdAt,
  }) {
    return RegisterResponseModel(
      ...
      deviceTokenModels: deviceTokenModels ?? this.deviceTokenModels,
...
class UserAddress {
  ...
  UserAddress copyWith({
    ...
    return UserAddress(
      ...
      usersDataModelTableId:
          usersDataModelTableId ?? this.usersDataModelTableId,
    );
  }
...
class DeliveryAddress {
  ...
  DeliveryAddress copyWith({
    ...
    return DeliveryAddress(
      ...
      phoneNo: phoneNo ?? this.phoneNo,
      address: address ?? this.address,
      addressPostCodes: addressPostCodes ?? this.addressPostCodes,
      city: city ?? this.city,
      state: state ?? this.state,
